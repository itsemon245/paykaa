                ...
                <div className="col-md-12">
                    <div className="tab-content">
                        <div className="tab-pane fade" id="members">
                            ...
                            <span className="logo"
                            ><img alt="" src="/assets/chat/img/logo.png"
                                /></span>
                            ...
                            <div className="contacts">
                                ...
                                <div className="list-group" id="contacts" role="tablist">
                                    ...
                                    >
                                        <img
                                            className="avatar-md"
                                            src="/assets/chat/img/avatars/avatar-female-1.jpg"
                                            data-toggle="tooltip"
                                            data-placement="top"
                                            title="Sarah"
                                            alt="avatar"
                                    ...
                                    >
                                        <img
                                            className="avatar-md"
                                            src="/assets/chat/img/avatars/avatar-male-2.jpg"
                                            data-toggle="tooltip"
                                            data-placement="top"
                                            title="james idoms"
                                            alt="avatar"
                                    ...
                                    >
                                        <img
                                            className="avatar-md"
                                            src="/assets/chat/img/avatars/avatar-female-3.jpg"
                                            data-toggle="tooltip"
                                            data-placement="top"
                                            title="Linda Gates"
                                            alt="avatar"
                                    ...
                                    >
                                        <img
                                            className="avatar-md"
                                            src="/assets/chat/img/avatars/avatar-female-6.jpg"
                                            data-toggle="tooltip"
                                            data-placement="top"
                                            title="Lisa Honey"
                                            alt="avatar"
                                    ...
                                    >
                                        <img
                                            className="avatar-md"
                                            src="/assets/chat/img/avatars/avatar-male-3.jpg"
                                            data-toggle="tooltip"
                                            data-placement="top"
                                            title="Daniel Cabral"
                                            alt="avatar"
                                    ...
                                    >
                                        <img
                                            className="avatar-md"
                                            src="/assets/chat/img/avatars/avatar-male-4.jpg"
                                            data-toggle="tooltip"
                                            data-placement="top"
                                            title="Jhon Doe"
                                            alt="avatar"
                            ...
                            <div className="notifications">
                                ...
                                <div className="list-group" id="alerts" role="tablist">
                                    ...
                                    >
                                        ...
                                        <div className="data">
                                            <p>
                                                Sarah has accepted your friend request on Talkshak.
                                            </p>
                                    ...
                                    >
                                        ...
                                        <div className="data">
                                            <p>
                                                Lisa Honey has a birthday today. Wish her all the
                                                best.
                                            </p>
                                    ...
                                    >
                                        ...
                                        <div className="data">
                                            <p>
                                                Jhon Doe has a birthday today. Wish him all the
                                                best.
                                            </p>
                                        ...
                                        >
                                            <div className="content layer">
                                                <div className="history">
                                                    ...
                                                    <p>
                                                        The messages won't be deleted or cleared on the
                                                    ...
                                                    <div className="custom-control custom-checkbox">
                                                        ...
                                                        >Hide will remove your chat history from the
                                                            recent list.</label
                                                        >
                                                    </div>
                                                    <div className="custom-control custom-checkbox">
                                            ...
                                            <div className="content no-layer">
                                                <div className="set">
                                                    <div className="details">
                                                        ...
                                                        <p>
                                                            You can set up Talkshak to receive
                                                            notifications when you have new messages.
                                                        </p>
                                                    </div>
                                                ...
                                                <div className="set">
                                                    <div className="details">
                                                        ...
                                                        <p>
                                                            If enabled shows a red badge on the Talkshak
                                                            app icon when you have unread messages.
                                                        </p>
                                                    </div>
                                                    <label className="switch">
                                                        <input type="checkbox" checked />
                                                ...
                                                <div className="set">
                                                    <div className="details">
                                                        ...
                                                        <p>
                                                            Flashes the Talkshak app on mobile in your
                                                            taskbar when you have new notifications.
                                                        </p>
                                                    </div>
                                                    <label className="switch">
                                                        <input type="checkbox" />
                                                ...
                                                <div className="set">
                                                    <div className="details">
                                                        ...
                                                        <p>
                                                            Set the app to alert you via notification
                                                            sound when you have unread messages.
                                                        </p>
                                                    </div>
                                                    <label className="switch">
                                                        <input type="checkbox" checked />
                                                ...
                                                <div className="set">
                                                    <div className="details">
                                                        <h5>Vibrate</h5>
                                                        <p>
                                                            Vibrate when receiving new messages (Ensure
                                                            system vibration is also enabled).
                                                        </p>
                                                    </div>
                                                    <label className="switch">
                                                        <input type="checkbox" />
                                    ...
                                    <div className="category">
                                        ...
                                        >
                                            <div className="content">
                                                <div className="app">
                                                    <img
                                                        src="/assets/chat/img/integrations/slack.svg"
                                                        alt="app"
                                                    />
                                                ...
                                                <div className="app">
                                                    <img
                                                        src="/assets/chat/img/integrations/dropbox.svg"
                                                        alt="app"
                                                    />
                                                    <div className="permissions">
                                                        <h5>Dropbox</h5>
                                                ...
                                                <div className="app">
                                                    <img
                                                        src="/assets/chat/img/integrations/drive.svg"
                                                        alt="app"
                                                    />
                                                    <div className="permissions">
                                                        <h5>Google Drive</h5>
                                                ...
                                                <div className="app">
                                                    <img
                                                        src="/assets/chat/img/integrations/trello.svg"
                                                        alt="app"
                                                    />
                                                    <div className="permissions">
                                                        <h5>Trello</h5>
                                            ...
                                            <div className="content no-layer">
                                                <div className="set">
                                                    <div className="details">
                                                        ...
                                                        <p>
                                                            The dark mode is applied to core areas of the
                                                            app that are normally displayed as light.
                                                        </p>
                                                    </div>
                                                    <label className="switch">
                                                        <input type="checkbox" />
                                            ...
                                            <div className="content no-layer">
                                                <div className="set">
                                                    <div className="details">
                                                        <h5>Keep Me Safe</h5>
                                                        <p>
                                                            Automatically scan and delete direct messages
                                                            you receive from everyone that contain explict
                                                            content.
                                                        </p>
                                                    </div>
                                                    <label className="switch">
                                                ...
                                                <div className="set">
                                                    <div className="details">
                                                        ...
                                                        <p>
                                                            Only your friends or your mutual friends will
                                                            be able to send you a friend reuqest.
                                                        </p>
                                                    </div>
                                                    <label className="switch">
                                                        <input type="checkbox" checked />
                                                ...
                                                <div className="set">
                                                    <div className="details">
                                                        ...
                                                        <p>
                                                            This settings allows us to use your
                                                            information to customize Talkshak for you.
                                                        </p>
                                                    </div>
                                                    <label className="switch">
                                                        <input type="checkbox" />
