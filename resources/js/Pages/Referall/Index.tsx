...
export default function Referall() {
    ...
    return <>
        ...
        <div className="mt-5">
            ...
            <h1 className="!text-3xl !font-bold my-3 !text-gray-800">Referrals</h1>
            <DataTable className="rounded-lg overflow-hidden" emptyMessage={<div className="text-center font-bold">No referrals Yet</div>} dataKey="id" value={referrals} tableStyle={{ minWidth: '50rem' }}>
