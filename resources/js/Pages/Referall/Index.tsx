...
export default function Referall() {
    ...
    return <>
        ...
        <div className="mt-5">
            ...
            {referrals.length > 0 ? <DataTable className="rounded-lg overflow-hidden" emptyMessage={<div className="text-center font-bold">No referrals Yet</div>} dataKey="id" value={referrals} tableStyle={{ minWidth: '50rem' }}>
