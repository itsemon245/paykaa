                ...
                <div class="Section__layout">
                    <div class="RowLayout"
                        ...
                        <div class="ColumnLayout"
                            ...
                            <section class="Copy variant--Stat">
                                <header class="Copy__header">
                                    <h1 class="Copy__title">500M+</h1>
                                </header>
                                <div class="Copy__body">API requests per day, peaking at 13,000 requests a second.</div>
                            </section>
                            <section class="Copy HomepageGlobalSection__uptimeStat variant--Stat">
                                <header class="Copy__header">
                                    <h1 class="Copy__title">99.999%</h1>
                                </header>
                                <div class="Copy__body">historical uptime for <a class="Link"
                                       href="https://status.stripe.com/"
                                       data-js-controller="AnalyticsButton"
                                       data-analytics-category="Links"
                                       data-analytics-action="Clicked"
                                       data-analytics-label="Global Stripe services">Stripe services</a>.</div>
                            </section>
                            <section class="Copy variant--Stat">
                                <header class="Copy__header">
                                    <h1 class="Copy__title">90%</h1>
                                </header>
                                <div class="Copy__body">of U.S. adults have bought from businesses using Stripe.</div>
                            </section>
                            <section class="Copy variant--Stat">
                                <header class="Copy__header">
                                    <h1 class="Copy__title">135+</h1>
                                </header>
                                <div class="Copy__body">currencies and payment methods supported.</div>
                            </section>
                        </div>
                    </div>
                </div>
