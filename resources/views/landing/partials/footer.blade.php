...
<div class="ColumnLayout animate-active-section"
    ...
    data-columns="1">
    <section class="Copy HomepageGlobalSection__copy variant--Section">
        <div class="flex flex-col justify-center items-center gap-3 !w-full !text-center text-[var(--textColor)] font-[var(--bodyFont)] text-lg">
            <div class="font-medium px-2 text-xl">
                Say goodbye to sketchy transactions, make every deal safe and scam-free.
                <br>
                Download the app now and experience worry-free deals on the go.
            </div>
            <a href="/download" class="font-bold px-4 py-2 rounded-full inline-flex items-center gap-2 !text-[var(--backgroundColor)] !bg-[var(--accentColor)]">
                <span class="Button__label">Download APK</span>
                <x-phosphor-download-duotone class="w-6 h-6" />
            </a>
        </div>
    </section>
</div>
